...
public class MediaAssetConfiguration : IEntityTypeConfiguration<MediaAsset>
{
    public void Configure(EntityTypeBuilder<MediaAsset> builder)
    {
        ...
        builder.Property(m => m.CdnUrl).HasMaxLength(2048);
        ...
        builder.Property(m => m.StorageProvider).HasConversion<int>().HasDefaultValue(StorageProvider.Local);
        ...
        builder.Property(m => m.HlsManifestUrl).HasMaxLength(2048);
        builder.Property(m => m.Codec).HasMaxLength(100);
        builder.Property(m => m.ExtractedMetadata).HasColumnType("jsonb");
        builder.Property(m => m.AiGeneratedTags).HasColumnType("jsonb");
        builder.Property(m => m.OcrText).HasColumnType("text");
